<template>
    <section class="space-y-20">
        <div v-if="projectThumbnails" id="projects">
            ...
            <div class="grid  grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3  gap-8 md:gap-2 xl:gap-8 w-full auto-rows-max overflow-hidden">
                <Project
...
export default {
    ...
    computed : {
        ...
        sortedHeartProjectThumbnailsLength(){
            if(!this.sortedHeartProjectThumbnails)return 0;
